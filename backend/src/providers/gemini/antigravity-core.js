...
const OAUTH_CLIENT_ID = process.env.ANTIGRAVITY_CLIENT_ID || 'YOUR_CLIENT_ID';
const OAUTH_CLIENT_SECRET = process.env.ANTIGRAVITY_CLIENT_SECRET || 'YOUR_CLIENT_SECRET';
